...
public class MonitoringRecord implements Serializable {
  ...
  @Override public Object clone() throws CloneNotSupportedException {
    MonitoringRecord clone = (MonitoringRecord) super.clone();
    clone.stateCode = this.stateCode;
    clone.countyCode = this.countyCode;
    clone.siteNum = this.siteNum;
    clone.parameterCode = this.parameterCode;
    clone.poc = this.poc;
    clone.latitude = this.latitude;
    clone.longitude = this.longitude;
    clone.datum = this.datum;
    clone.parameterName = this.parameterName;
    clone.dateLocal = this.dateLocal;
    clone.timeLocal = this.timeLocal;
    clone.dateGMT = this.dateGMT;
    clone.timeGMT = this.timeGMT;
    clone.sampleMeasurement = this.sampleMeasurement;
    clone.unitsOfMeasure = this.unitsOfMeasure;
    clone.mdl = this.mdl;
    clone.uncertainty = this.uncertainty;
    clone.qualifier = this.qualifier;
    clone.methodType = this.methodType;
    clone.methodCode = this.methodCode;
    clone.methodName = this.methodName;
    clone.stateName = this.stateName;
    clone.countyName = this.countyName;
    clone.dateOfLastChange = this.dateOfLastChange;
    clone.prediction = this.prediction;
    clone.error = this.error;
    clone.anomaly = this.anomaly;
    clone.predictionNext = this.predictionNext;
    return clone;
