...
public class HTMNetwork implements Serializable {
  ...
  private Map<String, Map<String, Object>> getFieldEncodingMap() {
    Map<String, Map<String, Object>> fieldEncodings =
      setupMap( null, 0, 0, 0.0d, 0.0d, 0.0d, 0.0d, null, null, null, STR_DT, "datetime", "DateEncoder" );
    ...
    fieldEncodings =
      setupMap( fieldEncodings, 0, 51, 0.0d, 0.1d, 0.0d, 0.001d, null, Boolean.TRUE, null, STR_MEASUREMENT, "float",
        "ScalarEncoder" );

    return fieldEncodings;
  }

  private Map<String, Class<? extends Classifier>> getInferredFieldsMap( String field,
  ...
  private Parameters getNetworkParams() {
    ...
    // ENCODER PARAMETERS
    p.set( Parameters.KEY.FIELD_ENCODING_MAP,
      getFieldEncodingMap() );  /// !!!!! check after this if the N, W etc. is set properly
