...
public class ResultState implements Serializable {
  ...
  ResultState( int recordNumber, Map<String, Object> inputMap, double actual, double prediction, double error,
               double anomaly, double predictionNext ) {
  ...
  public void setState( int recordNumber, Map<String, Object> inputMap, double actual, double prediction, double error,
                        double anomaly, double predictionNext ) {
    this.recordNumber = recordNumber;
    this.inputMap = inputMap;
    this.actual = actual;
